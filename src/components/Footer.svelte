<script lang="ts">
  ...
  $: if (isSubmitting) submitProgress.set(100); else submitProgress.set(0);
  ...
  const contactInfo = {
    ...
    address: {
      line1: 'Headington, Oxford',
      line2: 'Oxfordshire, United Kingdom OX4 2DD'
    }
  };
  ...
  const formHandlers = {
    validateEmail: (email: string) => config.emailRegex.test(email),
    ...
    showEmailError: () => {
      ...
      if (!formHandlers.validateEmail(email)) {
    ...
    handleSubmit: async (event: Event) => {
      ...
      if (!formHandlers.showEmailError() || isSubmitting) return;
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
      <div class="flex flex-col gap-6">
        ...
        <div class="flex flex-col gap-4 max-w-[28.25rem]">
          ...
          <form 
            on:submit={formHandlers.handleSubmit} 
          ...
          >
            <div class="flex flex-col gap-2">
              ...
              <input
                ...
                type="email"
                bind:value={email}
                on:blur={formHandlers.showEmailError}
            ...
            {#if submitMessage}
              ...
              >
                {#if submitSuccess}
                  <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" transition:scale={{ duration: 300, delay: 100 }}>
      ...
      <div class="flex flex-col gap-6">
        ...
        >
          ...
          <div class="flex flex-col gap-1">
            ...
            <p class="text-lg">{contactInfo.address.line1}</p>
            <p class="text-lg">{contactInfo.address.line2}</p>
          </div>
          ...
          >
            {#each socialLinks as social (social.id)}
              <a 
                ...
                transition:scale={{ duration: 300, delay: Math.random() * 200 }}
              >
